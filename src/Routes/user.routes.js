 ...
 */
route.post('/signUpUser', validate(userSchema.registerValidation), userController.register)
 ...
 *         description: Internal Server Error
 */
route.post('/logInUser', validate(userSchema.loginValidation), userController.logInUser)
 ...
 *         description: Internal Server Error
 */
route.post('/socialLogIn', validate(userSchema.socialValidation), userController.socialLogInUser)
 ...
 *         description: Internal Server Error
 */
route.post('/updateUser', authorize, validate(userSchema.updateUserValidation), upload.single('profileImage'), userController.updateUser);
 ...
 *         description: Internal Server Error
 */
route.post('/uploadProfileImage', authorize, upload.single('image'), userController.uploadProfileImage)
 ...
 *         description: Internal Server Error
 */
route.put('/changePassword', authorize, validate(userSchema.changePasswordValidation), userController.changePassword)
 ...
 *         description: Internal Server Error
 */
route.post('/forgetPassword', validate(userSchema.forgetPasswordValidation), userController.forgetPassword)
 ...
 *         description: Internal Server Error
 */
route.post('/otpVerification', validate(userSchema.otpVerificationValidation), userController.otpVerification)
 ...
 *         description: Internal Server Error
 */
route.post('/resetPassword', validate(userSchema.resetPasswordValidation), userController.resetPassword)
